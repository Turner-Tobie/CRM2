...
public class IndexController {
	...
	public String sendEmail(Email email, Model model) {
		...
		//error here 
		//at com.users.controller.IndexController.sendEmail(IndexController.java:176) ~[bin/:na]
		//at com.users.controller.IndexController$$FastClassBySpringCGLIB$$a3a760f.invoke(<generated>) ~[bin/:na]
